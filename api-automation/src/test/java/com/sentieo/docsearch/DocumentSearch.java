...
public class DocumentSearch extends APIDriver {
	...
	@Test(groups = "sanity", description = "fetch_saved_filters")
	public void fetchsavedfilters() throws Exception {
	...
	@Test(groups="sanity", description= "bulk_download", dataProvider= "fetch_search_SearchOnly", dataProviderClass = DataProviderClass.class) 
	public void bulk_download(String doc_ids, String email) throws Exception {
		try {
	...
	@Test(groups="sanity", description= "fetch_docs_meta_data", dataProvider= "fetch_search_SearchOnly", dataProviderClass = DataProviderClass.class) 
	public void fetch_docs_meta_data(String doc_ids) throws Exception {
		try {
	...
	public void fetchnotefilters() throws Exception {
	...
	public void fetch_custom_doc_diff(String doc_id, String custom_doc_id) throws Exception {
	...
	public void fetch_impact_score(String did, String query) throws Exception {
	...
	@Test(groups = "sanity", description = "fetch_search", dataProvider = "fetch_search_SearchOnly", dataProviderClass = DataProviderClass.class)
	public void fetchsearch(String ticker, String query, String fillingtype, String filing_subtype, String sensivity,
		String facets_flag) throws Exception {
	...
	public void fetchsearchtickerOnly(String ticker, String facets_flag) throws Exception {
	...
	@Test(groups = "sanity", description = "fetchsearch2", dataProvider = "fetch_search_SearchOnly", dataProviderClass = DataProviderClass.class)
	public void fetchsearch2(String no_docs, String facets_flag, String error) throws Exception {
	...
	@Test(groups = "sanity", description = "fetch_search_tickerOnly", dataProvider = "fetch_search_SearchOnly", dataProviderClass = DataProviderClass.class)
	public void fetchsearchSearchOnly(String query, String facets_flag) throws Exception {
	...
	@Test(groups = "sanity", description = "fetchsearch1", dataProvider = "SearchProvider", dataProviderClass = DataProviderClass.class)

	public void fetchsearchDoctype(String fillingtype, String facets_flag) throws Exception {
	...
	@Test(groups = "sanity", description = "fetchsearch1", dataProvider = "SearchProvider", dataProviderClass = DataProviderClass.class)
	public void fetchsearchSector(String fillingtype, String facets_flag) throws Exception {
	...
	//@Test(groups = "sanity", description = "fetchsearch1", dataProvider = "SearchProvider", dataProviderClass = DataProviderClass.class)
	public void fetchsearchRegions(String fillingtype, String facets_flag) throws Exception {
	...
	@Test(groups = "sanity", description = "fetchsearchSource", dataProvider = "SearchProvider", dataProviderClass = DataProviderClass.class)
	public void fetchsearchSource(String facets_flag) throws Exception {
	...
	@Test(groups = "sanity", description = "fetchsearchSource", dataProvider = "SearchProvider", dataProviderClass = DataProviderClass.class)
	public void fetchsearchDate(String period, String facets_flag) throws Exception {
