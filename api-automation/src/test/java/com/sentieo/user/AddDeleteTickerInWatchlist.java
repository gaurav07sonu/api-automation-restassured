...
public class AddDeleteTickerInWatchlist extends APIDriver {
	...
	public void addTickerWatchlist() throws Exception {
		...
		try {
			...
			if (statusCode == 200) {
				...
				List<String> updatedTickerPortFolio = userPortfolio(watchName, watchId);
				if (watchTicker != null) {
	...
	public ArrayList<String> userPortfolio(String watchName, String watchID) throws CoreCommonException {
