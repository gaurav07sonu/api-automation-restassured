...
public class DataProviderClass {
	...
	public Object[][] getDataFromDataprovider(Method testmethodname) {
		...
		if (testmethodname.getName().equalsIgnoreCase("fetchsearchRegions")) {
			groupArray = new Object[][] { { "{\"United States\":{\"United States\":[\"us\"]}}" },
					{ "{\"Canada\":{\"Canada\":[\"ca\"]}}" },
					{ "{\"Latin America & Caribbean\":{\"South America\":[\"pe\",\"br\",\"co\",\"cl\",\"ar\",\"ve\"],\"Mexico\":[\"mx\"],\"Caribbean\":[\"vg\",\"ky\",\"bm\",\"jm\"]}}","false" },
					{ "{\"Europe\":{\"Western Europe\":[\"gb\",\"de\",\"it\",\"fr\",\"ch\",\"be\",\"ie\",\"es\",\"lu\",\"nl\",\"fi\",\"pt\",\"gr\",\"dk\",\"mt\",\"is\",\"no\",\"gi\",\"se\"],\"Central & Eastern Europe\":[\"ru\",\"pl\",\"hu\",\"cz\",\"lv\",\"bg\",\"at\",\"ee\",\"cy\",\"ro\",\"si\",\"lt\",\"sk\",\"ua\"],\"Southern Europe\":[\"hr\",\"mk\",\"rs\",\"me\"]}}" ,"true"},
					{ "{\"Middle East & Africa\":{\"Middle East\":[\"qa\",\"ae\",\"om\",\"bh\",\"il\",\"sa\",\"jo\",\"kw\",\"lb\",\"ps\",\"sy\",\"tr\"],\"Africa\":[\"za\",\"eg\",\"ng\",\"mu\",\"ke\",\"ma\",\"gh\",\"mw\",\"na\",\"tn\",\"ug\",\"tz\"]}}" ,"false"},
					{ "{\"Asia Pacific\":{\"East Asia\":[\"jp\",\"cn\",\"tw\",\"kr\",\"hk\"],\"South East Asia\":[\"id\",\"ph\",\"my\",\"th\",\"vn\",\"sg\"],\"South Asia\":[\"in\",\"bd\",\"lk\",\"pk\"],\"Central Asia\":[\"kz\"]}}" ,"false" },
					{ "{\"Australia & Oceania\":{\"Australia\":[\"au\"],\"Oceania\":[\"nz\",\"pg\"]}}" ,"true"},
					{ "{\"Smart Groupings\":{\"G-10\":[\"gb\",\"jp\",\"de\",\"it\",\"fr\",\"ch\",\"be\",\"ca\",\"nl\",\"us\",\"se\"],\"Emerging Markets\":[\"pe\",\"qa\",\"cn\",\"id\",\"br\",\"ph\",\"my\",\"in\",\"za\",\"ru\",\"th\",\"pl\",\"co\",\"hu\",\"mx\",\"ae\",\"tw\",\"cz\",\"eg\",\"cl\"],\"Frontier Markets\":[\"qa\",\"vn\",\"ng\",\"bg\",\"ee\",\"cy\",\"ro\",\"si\",\"mt\",\"lt\",\"sk\",\"mu\",\"ar\",\"om\",\"bh\",\"ke\"],\"BRICS\":[\"cn\",\"br\",\"in\",\"za\",\"ru\"],\"Next Eleven\":[\"id\",\"ph\",\"mx\",\"eg\",\"kr\",\"vn\",\"ng\"],\"European Union\":[\"gb\",\"de\",\"it\",\"fr\",\"be\",\"pl\",\"hu\",\"cz\",\"ie\",\"lv\",\"bg\",\"es\",\"at\",\"lu\",\"nl\",\"ee\",\"cy\",\"fi\",\"ro\",\"pt\",\"gr\",\"dk\",\"si\",\"mt\",\"lt\"]}}" ,"false"} };
		} else if (testmethodname.getName().equalsIgnoreCase("fetchsearchSector")) {
			groupArray = new Object[][] { { "Communication Services#$","true" }, { "Industrials#$" ,"false"}, { "Consumer Staples#$","false" },
					{ "Health Care#$" ,"false"}, { "Materials#$","false" }, { "Information Technology#$","false" },
					{ "Consumer Discretionary#$","false" }, { "Utilities#$","true" }, { "Real Estate#$","true" }, { "Energy#$","true" },
					{ "Financials#$" ,"false"}, { "Other#$" ,"true"} };
		} else if (testmethodname.getName().equalsIgnoreCase("fetchsearchDate")) {
			groupArray = new Object[][] { { "all" ,"true"}, { "7d","false" }, { "1m","false" }, { "3m" ,"false"}, { "6m","true" }, { "1y","true" }, { "2y","true" },
					{ "5y" ,"false"}, { "10y","false" } };
		} else if (testmethodname.getName().equalsIgnoreCase("fetchsearchDoctype")) {
			groupArray = new Object[][] { { "ef#$","false" }, { "tt#$" ,"true"}, { "ppt#$","false" }, { "ni#$","true" }, { "gbf#$","false" }, { "nw#$","false" } };
	...
	public Object[][] fetchGraphData() {
		Object[][] groupArray = null;
		groupArray = new String[][] { { "Revenue","sales","ibes" }, { "COGS","cogs","rf" }, { "Gross Profit","gross_profit","rf"}};
		return groupArray;
		}
	@DataProvider(name = "fetch_data")
	public Object[][] fetchData() {
		Object[][] groupArray = null;
		groupArray = new String[][] {{"P/E","p_eps","rf"},{"EV/Sales","ev_sales","rf"},{"EV/EBITDA","ev_ebitda","rf"}};
		return groupArray;
		}
